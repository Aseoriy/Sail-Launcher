...
i also just updated it with a bunch of new stuff for v4.0.0. it now has a full big picture mode with controller support and a virtual keyboard. it automatically tracks your playtime now and has a stats page to show your most played games. you can also add console roms directly now and just link your emulator exe to it. there is a social sidebar that connects to steam and discord so you can see if your friends are online and what they are playing. i also added dynamic folders for recently played games, a surprise me button that picks a random unplayed game, and the ability to run .bat or powershell scripts right before or after a game launches. there's even a plugin api now if you want to write your own javascript plugins for it.
