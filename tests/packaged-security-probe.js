...
const reviewedFiles = [
    ...
    'accounts/profileStore.js',
    'runtime/downloadHostResolvers.js',
    'runtime/downloadResolutionLifecycle.js',
    'runtime/fileCryptResolver.js',
    'runtime/systemBrowserResolver.js',
    ...
    'runtime/ownedWorker.js',
    'runtime/archiveExtractWorker.js',
    'runtime/downloadPreparationWorker.js',
    'runtime/fitGirlInstaller.ps1',
    'ui/downloadQuarantine.js',
    'ui/downloadSourceLogic.js',
    'ui/remoteJson.js',
    'accounts/ipc.js',
    'maintenance/ipc.js',
    'achievements/ipc.js'
